...
function  Navbar(){
    ...
    return(
        <>
            <nav className="font-body h-24 flex  justify-center bg-mainColor text-white items-center border-b-2 ">
                <Link to="/" className="font-body text-white text-2xl flex w-56 justify-between hover:bg-gradient-to-r from-textcolor  to-textcolor2 bg-clip-text hover:text-transparent ">
